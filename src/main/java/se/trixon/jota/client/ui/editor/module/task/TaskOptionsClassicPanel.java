 ...
 */
public class TaskOptionsClassicPanel extends TaskModule {

    /**
     * Creates new form ModulePanel
     */
    public TaskOptionsClassicPanel() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        timesCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.timesCheckBox.text")); // NOI18N
        timesCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.timesCheckBox.toolTipText")); // NOI18N

        ownerCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.ownerCheckBox.text")); // NOI18N
        ownerCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.ownerCheckBox.toolTipText")); // NOI18N
        ...
        permsCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.permsCheckBox.text")); // NOI18N
        permsCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.permsCheckBox.toolTipText")); // NOI18N

        groupCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.groupCheckBox.text")); // NOI18N
        groupCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.groupCheckBox.toolTipText")); // NOI18N
        ...
        verboseCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.verboseCheckBox.text")); // NOI18N
        verboseCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.verboseCheckBox.toolTipText")); // NOI18N

        ignoreExistingCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.ignoreExistingCheckBox.text")); // NOI18N
        ignoreExistingCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.ignoreExistingCheckBox.toolTipText")); // NOI18N

        updateCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.updateCheckBox.text")); // NOI18N
        updateCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.updateCheckBox.toolTipText")); // NOI18N

        deleteCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.deleteCheckBox.text")); // NOI18N
        deleteCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.deleteCheckBox.toolTipText")); // NOI18N
        ...
        oneFileSystemCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.oneFileSystemCheckBox.text")); // NOI18N
        oneFileSystemCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.oneFileSystemCheckBox.toolTipText")); // NOI18N

        progressCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.progressCheckBox.text")); // NOI18N
        progressCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.progressCheckBox.toolTipText")); // NOI18N

        sizeOnlyCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.sizeOnlyCheckBox.text")); // NOI18N
        sizeOnlyCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.sizeOnlyCheckBox.toolTipText")); // NOI18N

        modifyWindowCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.modifyWindowCheckBox.text")); // NOI18N
        modifyWindowCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.modifyWindowCheckBox.toolTipText")); // NOI18N
        ...
        checksumCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.checksumCheckBox.text")); // NOI18N
        checksumCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.checksumCheckBox.toolTipText")); // NOI18N

        devicesCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.devicesCheckBox.text")); // NOI18N
        devicesCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.devicesCheckBox.toolTipText")); // NOI18N

        partialProgressCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.partialProgressCheckBox.text")); // NOI18N
        partialProgressCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.partialProgressCheckBox.toolTipText")); // NOI18N

        linksCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.linksCheckBox.text")); // NOI18N
        linksCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.linksCheckBox.toolTipText")); // NOI18N

        backupCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.backupCheckBox.text")); // NOI18N
        backupCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.backupCheckBox.toolTipText")); // NOI18N

        dirsCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.dirsCheckBox.text")); // NOI18N
        dirsCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.dirsCheckBox.toolTipText")); // NOI18N
        ...
        compressCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.compressCheckBox.text")); // NOI18N
        compressCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.compressCheckBox.toolTipText")); // NOI18N

        existingCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.existingCheckBox.text")); // NOI18N
        existingCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.existingCheckBox.toolTipText")); // NOI18N

        numericIdsCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.numericIdsCheckBox.text")); // NOI18N
        numericIdsCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.numericIdsCheckBox.toolTipText")); // NOI18N

        hardlinksCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.hardlinksCheckBox.text")); // NOI18N
        hardlinksCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.hardlinksCheckBox.toolTipText")); // NOI18N

        itemizeChangesCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.itemizeChangesCheckBox.text")); // NOI18N
        itemizeChangesCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.itemizeChangesCheckBox.toolTipText")); // NOI18N

        protectArgsCheckBox.setText(bundle.getString("TaskOptionsClassicPanel.protectArgsCheckBox.text")); // NOI18N
        protectArgsCheckBox.setToolTipText(bundle.getString("TaskOptionsClassicPanel.protectArgsCheckBox.toolTipText")); // NOI18N
