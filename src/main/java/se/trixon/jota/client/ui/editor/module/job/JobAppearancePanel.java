...
public class JobAppearancePanel extends JobModule {
    ...
    public void loadJob(Job job) {
        if (job.getColorBackground() != null) {
            previewButton.setBackground(job.getColorBackground());
        }

        if (job.getColorForeground() != null) {
            previewButton.setForeground(job.getColorForeground());
        }
    }
    ...
    public Job saveJob(Job job) {
        if (!previewButton.getBackground().equals(resetButton.getBackground())) {
            job.setColorBackground(previewButton.getBackground());
        }

        //if (!previewButton.getForeground().equals(resetButton.getForeground())) {
        job.setColorForeground(previewButton.getForeground());
        //}
